                    ...
                    {if $view.template == $sitetemplate} site-template{/if}">
                        <h3 class="panel-heading has-link">
                            ...
                            href="
                                ...
                                {elseif $view.template == 'qmdashboard'}
                                    {$WWWROOT}module/qmframework/dashboard.php?id={$view.id}
                        ...
                        <div class="panel-footer">
                            ...
                            <div class="page-controls">
                                ...
                                {/if}
                                {if !$view.submittedto && $view.removable && !$noedit && (!$view.locked || $editlocked) || ($view.type == 'qmdashboard' && $view.institution != null && $USER->get('admin'))}
                                    <li>
                                    {if $view.collid}
