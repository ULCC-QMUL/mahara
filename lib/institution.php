 ...
 * @param bool $withactiveinstitutiontags  To add to the drop-down just the institutions with institutiontags
 *
...
function get_institution_selector($includedefault = true, $assumesiteadmin=false, $includesitestaff=false,
    $includeinstitutionstaff=false, $allselector=false, $withactiveinstitutiontags=false) {
    global $USER;
