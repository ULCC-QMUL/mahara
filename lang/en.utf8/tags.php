...
$string['canteditinstitutiontags'] = 'You are not allowed to edit institution tags.';
...
$string['institutiontagdeleted'] = 'Instituion Tag deleted successfully.';
$string['institutiontags'] = 'Institution tags';
$string['institutiontagsaved'] = 'Institution tag saved.';
$string['institutiontagsfor'] = 'Institution tags for \'%s\'';
$string['institutiontagsdescription'] = 'The institution tags are a set predefined by the institution and available for use by all the institution members. You can create as many tags as you like.';
$string['notags'] = 'No tags yet.';
